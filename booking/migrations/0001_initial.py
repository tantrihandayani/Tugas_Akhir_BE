    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='layanan/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_method', models.CharField(choices=[('qris', 'QRIS')], default='qris', max_length=20)),
                ...
                ('layanan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booking.menulayanan')),
            ],
        ),
    ]
